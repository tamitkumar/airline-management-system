...
import static airline.management.system.utils.AirlineConstant.HTTP_CODE_500;
import static airline.management.system.utils.AirlineConstant.HYPHEN;
...
public class AirlineException extends RuntimeException {
    ...
    public AirlineException(Exception exception) {
        super(exception);
    ...
    public AirlineException(String code, String message) {
        super(message);
    ...
    public AirlineException(String code, ErrorSeverity severity, String message) {
        super(message);
    ...
    public AirlineException(String code, ErrorSeverity severity, String message, Exception exception) {
        super(exception);
        String builder = code + HYPHEN + severity + HYPHEN + message;
        this.code = code;
        this.message = builder;
